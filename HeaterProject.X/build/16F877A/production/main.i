...
# 52 "C:/Program Files (x86)/Microchip/MPLABX/v5.40/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8\pic\include\proc\pic16f877a.h"
...
# 30 "C:/Program Files (x86)/Microchip/MPLABX/v5.40/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8\pic\include\pic.h"
...
# 114 "C:/Program Files (x86)/Microchip/MPLABX/v5.40/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8\pic\include\eeprom_routines.h"
extern void eeprom_write(unsigned char addr, unsigned char value);
extern unsigned char eeprom_read(unsigned char addr);


# 91 "C:/Program Files (x86)/Microchip/MPLABX/v5.40/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8\pic\include\pic.h"
...
unsigned char tempSet = 60;
unsigned char tempCurr;
...
powerMode = 1;
if (e2pext_r(11) == 0xFB) {
tempSet = (unsigned char) e2pext_r(10);
}
} else {
...
notPressed = 0;
mask7S = 0xFF;
e2pext_w(10, (unsigned char) tempSet);
e2pext_w(11, 0xFB);
